...
```console
EKSCTL_EXPERIMENTAL=true eksctl install flux -f examples/01-simple-cluster.yaml --git-url=git@github.com:nholuongut/cluster-1-gitops.git --git-email=johndoe+flux@nholuongut.works
```
...
```console
$ EKSCTL_EXPERIMENTAL=true ./eksctl install flux --cluster=cluster-1 --region=eu-west-2  --git-url=git@github.com:nholuongut/cluster-1-gitops.git  --git-email=johndoe+flux@nholuongut.works --namespace=flux
...
[ℹ]  Cloning git@github.com:nholuongut/cluster-1-gitops.git
...
[ℹ]  Committing and pushing manifests to git@github.com:nholuongut/cluster-1-gitops.git
[master ec43024] Add Initial Flux configuration
 Author: Flux <johndoe+flux@nholuongut.works>
...
To github.com:nholuongut/cluster-1-gitops.git
   5fe1eb8..ec43024  master -> master
[ℹ]  Flux will only operate properly once it has write-access to the Git repository
[ℹ]  please configure git@github.com:nholuongut/cluster-1-gitops.git  so that the following Flux SSH public key has write access to it
...
```console
EKSCTL_EXPERIMENTAL=true eksctl generate profile --config-file=<cluster_config_file> --git-url git@github.com:nholuongut/eks-quickstart-app-dev.git --profile-path <output_directory>
```

For example:

```
$ EKSCTL_EXPERIMENTAL=true eksctl generate profile  --config-file 01-simple-cluster.yaml --git-url git@github.com:nholuongut/eks-quickstart-app-dev.git --profile-path my-gitops-repo/base/
[ℹ]  cloning repository "git@github.com:nholuongut/eks-quickstart-app-dev.git":master
...
[app-dev]: https://github.com/nholuongut/eks-quickstart-app-dev

...
kops create cluster cluster-1.k8s.local --zones=us-west-2c,us-west-2b,us-west-2a --networking=nholuongut --yes
```
...
See the complete example [here](https://github.com/nholuongut/eksctl/blob/master/examples/09-nat-gateways.yaml).

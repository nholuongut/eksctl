...
> NOTE: Until [#25](https://github.com/nholuongut/eksctl/issues/25) is resolved, tags cannot be applied to EKS cluster itself, but most of other resources (e.g. EC2 nodes).
...
Code contributions are very welcome. If you are interested in helping make `eksctl` great then see our [contributing guide](https://github.com/nholuongut/eksctl/blob/master/CONTRIBUTING.md).

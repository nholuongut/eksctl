...
import (
	...
	"github.com/nholuongut/eksctl/pkg/gitops"
	"github.com/nholuongut/eksctl/pkg/gitops/fileprocessor"
...
func repoURLForQuickstart(quickstartArgument string) (string, error) {
	...
	if quickstartArgument == "app-dev" {
		return "git@github.com:nholuongut/eks-quickstart-app-dev.git", nil
	}

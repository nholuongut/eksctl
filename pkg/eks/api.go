...
import (
	...
	"github.com/nholuongut/eksctl/pkg/ami"
	api "github.com/nholuongut/eksctl/pkg/apis/eksctl.io/v1alpha5"
	"github.com/nholuongut/eksctl/pkg/az"
	"github.com/nholuongut/eksctl/pkg/cfn/manager"
	"github.com/nholuongut/eksctl/pkg/utils"
	"github.com/nholuongut/eksctl/pkg/version"
)
...
func New(spec *api.ProviderConfig, clusterSpec *api.ClusterConfig) *ClusterProvider {
	...
	provider.sts = sts.New(s,
		...
		// (see https://github.com/nholuongut/eksctl/issues/705)

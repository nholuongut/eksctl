...
import (
	...
	cft "github.com/nholuongut/eksctl/pkg/cfn/template"
	iamoidc "github.com/nholuongut/eksctl/pkg/iam/oidc"

	. "github.com/nholuongut/eksctl/pkg/cfn/template/matchers"
...
var _ = Describe("template builder for IAM", func() {
	...
	BeforeEach(func() {
		oidc, err = iamoidc.NewOpenIDConnectManager(nil, "456123987123", "https://oidc.eks.us-west-2.amazonaws.com/id/A39A2842863C47208955D753DE205E6E")

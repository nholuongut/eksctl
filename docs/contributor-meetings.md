...
- `eksctl utils describe-stacks`
  - additon of `--trail`
  - call for help on improving output [#585](https://github.com/nholuongut/eksctl/issues/585)
...
Topics:
- upgrades - [#608](https://github.com/nholuongut/eksctl/issues/608)
...
- upgrades - [#608](https://github.com/nholuongut/eksctl/issues/608)
   - `k8s.io/client-go` & co
   - `RawClient` and `RawResource` - [#624](https://github.com/nholuongut/eksctl/pull/624)
...
- more discussion around storing config objects [#642](https://github.com/nholuongut/eksctl/issues/642)
...
- v1alpha5
- nodegroup deletion [#664](https://github.com/nholuongut/eksctl/issues/664)

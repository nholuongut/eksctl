...
[nholuongut Community](https://nholuongut.github.io/community-slack/) Slack workspace and use the
[#eksctl](https://nholuongut-community.slack.com/messages/eksctl/) channel and/or the [mailing
list](maillist).
...
- Find an [issue](https://github.com/nholuongut/eksctl/issues) to work on or
  create your own. If you are a new contributor take a look at issues marked
  with [good first issue](https://github.com/nholuongut/eksctl/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22).
...
- Add automated tests to cover your changes. See the [az](https://github.com/nholuongut/eksctl/tree/master/pkg/az)
...
6. Ensure release jobs succeeded in [CircleCI](https://circleci.com/gh/nholuongut/eksctl).
7. Ensure the release was successfully [published in Github](https://github.com/nholuongut/eksctl/releases).
...
[Fail] (Integration) Create, Get, Scale & Delete when creating a cluster with 1 node and add the second nodegroup and delete the second nodegroup [It] {FLAKY: https://github.com/nholuongut/eksctl/issues/717} should make it 4 nodes total
/go/src/github.com/nholuongut/eksctl/integration/creategetdelete_test.go:376

[Fail] (Integration) Create, Get, Scale & Delete when creating a cluster with 1 node and scale the initial nodegroup back to 1 node [It] {FLAKY: https://github.com/nholuongut/eksctl/issues/717} should make it 1 nodes total
/go/src/github.com/nholuongut/eksctl/integration/creategetdelete_test.go:403
...
When you run `./tag-release.sh <tag>` it will push a commit to master and a tag, which will trigger [release workflow](https://github.com/nholuongut/eksctl/blob/38364943776230bcc9ad57a9f8a423c7ec3fb7fe/.circleci/config.yml#L28-L42) in Circle CI. This runs `make eksctl-image` followed by `make release`. Most of the logic is defined in [`do-release.sh`](https://github.com/nholuongut/eksctl/blob/master/do-release.sh).
...
That means you will see two entries on [the release page](https://github.com/nholuongut/eksctl/releases):

- [**eksctl 0.4.0 (permalink)**](https://github.com/nholuongut/eksctl/releases/tag/0.4.0)
- [**eksctl 0.4.0**](https://github.com/nholuongut/eksctl/releases/tag/latest_release)
